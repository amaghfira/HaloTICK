                    ...
                    <?php if ($tickets) : ?>
                        <?php foreach ($tickets as $ticket) : ?>
                            <tr>
                                ...
                                <td style="text-align: center;"><a href="<?= base_url('tiket/view/' . $ticket['id']); ?>" class="btn btn-info btn-sm btn-view">View</a> <a href="<?= base_url('tiket/show/' . $ticket['id']); ?>" class="btn btn-success btn-sm btn-edit">Edit</a> <a href="<?= base_url('tiket/delete/' . $ticket['id']); ?>" class="btn btn-danger btn-sm btn-delete" data-id="">Delete</a></td>
                            </tr>
                        <?php endforeach; ?>
                    <?php endif; ?>
                </tbody>
